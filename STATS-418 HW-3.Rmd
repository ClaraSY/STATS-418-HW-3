...
```{r}
# without early stop
xgb1 <- xgb.train(data = xgb_train, nthread = n_proc, objective = "binary:logistic", 
...
xgb2 <- xgb.train(data = xgb_train, nthread = n_proc, objective = "binary:logistic", 
...
# with early stop
xgb3 <- xgb.train(data = xgb_train, nthread = n_proc, objective = "binary:logistic", 
                    nround = 200, max_depth = 10, eta = 0.1,
...
xgb4 <- xgb.train(data = xgb_train, nthread = n_proc, objective = "binary:logistic", 
                    nround = 200, max_depth = 10, eta = 0.1,
